...
public class ShujiOrderView extends ShujiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 借阅状态的值
		*/
		private String shujiOrderValue;
	...
	public ShujiOrderView() {

	}

	public ShujiOrderView(ShujiOrderEntity shujiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, shujiOrderEntity);
			...
			* 获取： 借阅状态的值
			*/
			public String getShujiOrderValue() {
				return shujiOrderValue;
			}
			/**
			* 设置： 借阅状态的值
			*/
			public void setShujiOrderValue(String shujiOrderValue) {
				this.shujiOrderValue = shujiOrderValue;
			}
